...
namespace Nakatetsu.Train.Equipment.Tims.Tests
{
    public sealed class DoorTests
    {
        ...
        public void SetUp()
        {
            ...
            {
                AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Nakatetsu/Train/Equipment/Door/Prefabs/Door.prefab"),
            ...
            car.doorSimulationPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(
                "Assets/Nakatetsu/Train/Simulation/Door/Prefabs/TrainDoorSimulation.prefab");
            ...
            var simulationBuilder = train.AddComponent<TrainSimulationBuilder>();
        ...
        public void PrefabBuildsFourDoorsPerSideAndUnknownDoesNotMeanClosed()
        {
            ...
            foreach (var door in doors)
                Assert.That(door.Simulation.DoorsPerSide, Is.EqualTo(4));
        }
        ...
        public void LossOfOneCarNeverLeavesAllClosed(string failure)
        {
            ...
            if (failure == "simulation") doors[1].Simulation.enabled = false;
