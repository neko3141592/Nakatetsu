...
using Nakatetsu.Train.Traction.Motor;
...
namespace Nakatetsu.Train.Traction.Vvvf
{
    ...
    public sealed class VvvfController : MonoBehaviour, ITractionEquipment
    {
            ...
            float deltaTimeSeconds)
        {
            ...
            Step(vehicleSpeedMps, deltaTimeSeconds);
        }

        public void Step(float vehicleSpeedMps, float deltaTimeSeconds)
        {
            ApplyDefinition();
            ...
            PopulateInput(representativeMotor, vehicleSpeedMps, deltaTimeSeconds);
            ...
            float deltaTimeSeconds)
        {
            ...
            input.vehicleSpeedMps = vehicleSpeedMps;
